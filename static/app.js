...
function onClickedEstimatePrice() {
  ...
  // var url = "/api/predict_home_price"; // Use this in production (e.g., AWS EC2 with NGINX)
...
function onPageLoad() {
  ...
  // var url = "/api/get_location_names"; // Use this in production (e.g., AWS EC2 with NGINX)
